    ...
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <div class="page-utilities">
                <div class="col-auto">
                        <form class="table-search-form row gx-1 align-items-center" action="{{ route('violation.store') }}" method="POST">
                            @csrf
                            ...
                            <tbody>
                                @forelse($violationtypes as $violationtype)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <form id="conveyance-delete" action="{{ route('violation.destroy', $violationtype) }}" method="POST">
                                                @csrf
                                                @method('DELETE')

                                                <a class="btn-sm app-btn-secondary m-2" href="{{ route('violation.edit', $violationtype) }}">Edit</a>
