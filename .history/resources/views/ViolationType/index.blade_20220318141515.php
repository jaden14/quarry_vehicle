...
<!-- Modal -->
<div class="modal fade" id="addViolationType" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form class="table-search-form row gx-1 align-items-center" action="{{ route('violationtype.store') }}" method="POST">
            ...
            <div class="modal-body">
                <div class="col-auto">
                <input type="text" placeholder="description" name="description" class="form-control search-orders">
            </div>
            </div>
