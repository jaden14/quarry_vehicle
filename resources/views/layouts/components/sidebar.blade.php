            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="{{ Route::currentRouteNamed('home') ? 'nav-link active' : 'nav-link' }}" href="{{ route('home') }}">
                            <span class="nav-icon">
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="{{ Route::currentRouteNamed('conveyance') ? 'nav-link active' : 'nav-link' }}" href="{{ route('conveyance') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Conveyance</span>
                        </a><!--//nav-link-->
                    </li>

                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="{{ Route::currentRouteNamed('violationtype') ? 'nav-link active' : 'nav-link' }}" href="{{ route('violationtype') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">ViolationType</span>
                        </a><!--//nav-link-->
                    </li>

                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="{{ Route::currentRouteNamed('violationtype.index') ? 'nav-link active' : 'nav-link' }}" href="{{ route('violationtype.index') }}">
                        <span class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-octagon" viewBox="0 0 16 16">
                            <path d="M4.54.146A.5.5 0 0 1 4.893 0h6.214a.5.5 0 0 1 .353.146l4.394 4.394a.5.5 0 0 1 .146.353v6.214a.5.5 0 0 1-.146.353l-4.394 4.394a.5.5 0 0 1-.353.146H4.893a.5.5 0 0 1-.353-.146L.146 11.46A.5.5 0 0 1 0 11.107V4.893a.5.5 0 0 1 .146-.353L4.54.146zM5.1 1 1 5.1v5.8L5.1 15h5.8l4.1-4.1V5.1L10.9 1H5.1z"/>
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="{{ Route::currentRouteNamed('quarry') ? 'nav-link active' : 'nav-link' }}" href="{{ route('quarry') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Quarry</span>
                        </a><!--//nav-link-->
                    </li>
